...
<div class="tabs is-fullwidth" style="margin-bottom: 0px;">
    <ul>
        <li><a href="#">Meme Baru</a></li>
        <li><a href="#">Meme Populer</a></li>
        <li><a href="#">Meme Jelek</a></li>
        <li><a href="{{ route('meme.manage.index') }}">Meme Saya</a></li>
        <li><a href="{{ route('meme.manage.create') }}">Posting Meme</a></li>
    </ul>
</div>
@yield('content')
<footer class="footer">
