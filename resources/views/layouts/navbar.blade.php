<nav class="navbar navbar-expand-lg main-navbar">
    ...
    <ul class="navbar-nav navbar-right">
        ...
        <li class="dropdown"><a href="#" data-toggle="dropdown" class="nav-link dropdown-toggle nav-link-lg nav-link-user">
                ...
                <div class="d-sm-none d-lg-inline-block">Hi, {{ optional(Auth::user()->userDetail)->first_name }}</div></a>
            <div class="dropdown-menu dropdown-menu-right">
                <div class="dropdown-title">Logged in 5 min ago</div>
                <a href="{{ route('dashboard.account.index') }}" class="dropdown-item has-icon">
                    <i class="far fa-user"></i> Profile
                </a>
                <a href="{{ route('dashboard.account.password') }}" class="dropdown-item has-icon">
                ...
                <a href="#" class="dropdown-item ">
                    ...
                    <form action="{{ route('logout') }}" method="POST">
                        @csrf
                        <button class="btn btn-icon icon-left btn-primary"><i class="fas fa-sign-out-alt"></i> <span>Logout</span></button>
                    </form>
                </a>
            </div>
        </li>
