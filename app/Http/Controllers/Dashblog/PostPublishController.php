...
class PostPublishController extends Controller
{
    ...
    {
        $posts = $this->postRepo->index(StatusPostEnum::PUBLISH, $request);
        $search = $request->title;
        return view('dashblog.post.publish.index', compact('blogid', 'posts', 'search'));
    }
